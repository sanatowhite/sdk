...
readonly PUBLISHED_MODULES="updatechecker backupkit backupkit-drive core-common core-common-hilt core-init core-init-hilt core-ui core-net core-data core-data-hilt core-telemetry core-telemetry-hilt net-telemetry-hilt debug-tools telemetry-firebase feature-settings feature-feedback feature-licenses feature-update sdk-bom"
